...
<div class="row m-0 appac_hide">
    ...
    <div>
        <p class="d-block" style="cursor: pointer; font-weight: 700;" id="pendingstatus">Pending Due ({{$proformadata->total_open}}) - Rs. {{number_format($proformadata->total_grosspay ?? 0,2)}}</p>
        <p class="d-block" style="cursor: pointer; font-weight: 700;" id="pendingstatus">Last 90days Pending Due ({{$proformadata90days->total_open}}) - Rs. {{number_format($proformadata90days->total_grosspay ?? 0,2)}}</p>
    </div> 
