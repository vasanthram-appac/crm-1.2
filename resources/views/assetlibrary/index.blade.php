...
<div class="row m-0 appac_hide">
    <div class="d-flex justify-content-between  align-items-end  inside-nav mb-4">
        ...
        <ul class="nav nav-tabs  my-4  justify-content-end  mb-0  ">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="/asset_library"><b>Asset Library</b></a>
            </li>
            <li class="nav-item">
    ...
    <div class="profile col-12 col-lg-12 col-xl-12 col-xxl-12 d-flex justify-content-between flex-wrap  align-items-center  p-15">
        <div class="profile-head">
            <h1 class="ch2 comp-name">Asset Library</h1>
        </div>

        <div class=" justify-content-sm-end d-flex  gap-2 flex-wrap">
            <button class="btn bg-primary text-white ft-15 btn-modal pri-text-color m-0" data-container=".customer_modal" data-href="{{action([App\Http\Controllers\Assetlibrary::class,'create'])}}"><i class="fa fa-plus me-1" aria-hidden="true"></i> Add Asset Library</button>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        var cat_table = $('#example').DataTable({
            ...
            ajax: "{{ action([App\Http\Controllers\Assetlibrary::class,'index']) }}",
            columns: [{
                    data: 'sno',
                    name: 'sno'
                },
        ...
        $(document).on('click', '.conformdelete', function() {
            ...
            swal({
                title: "Alert",
                text: "Are you sure you want to delete the Asset Library?",
                icon: "warning",
                buttons: true,
                dangerMode: true,
                ...
                if (isConfirm) {
                    $.ajax({
                        url: '/asset_library/' + Id, // Change this to your endpoint
                        type: 'DELETE',
                        data: {
                            id: Id,
                            _token: '{{ csrf_token() }}',
                    ...
                    window.location.href = '/asset_library';
                }
            });
        });
