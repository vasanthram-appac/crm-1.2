...
<div class="row m-0 appac_hide">
    ...
    <div class="col-lg-12 col-sm-12 ">
        <div class="row user-dash col-wrap p-0">
                                ...
                                <div class="col-6 col-lg-6 p-0   align-content-center">
                                    <div class="svg-d">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="60px" height="60px" viewBox="0 0 24 24">
                                            <path fill="#999797" fill-rule="evenodd" d="m12.6 11.503l3.891 3.891l-.848.849L11.4 12V6h1.2zM12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10m0-1.2a8.8 8.8 0 1 0 0-17.6a8.8 8.8 0 0 0 0 17.6" />
                                        </svg>
