...
<div class="d-flex justify-content-between  align-items-end  inside-nav mb-4">
        ...
        <ul class="nav nav-tabs my-4 justify-content-end mb-0">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="/webproposal"><b>Web Proposal</b></a>
            </li>
            <li class="nav-item">
...
<div class="profile  col-12 col-lg-12 col-xl-12 col-xxl-12 d-flex justify-content-between flex-wrap  align-items-center  p-15">
        <div class="profile-head">
            <h1 class="ch2 comp-name">Web Proposal</h1>
        </div>
        <div class="justify-content-sm-end d-flex">
                <div class=""></div>
                <button class="btn bg-primary text-white ft-15 btn-modal pri-text-color m-0" data-container=".customer_modal" data-href="{{action([App\Http\Controllers\Webproposal::class,'create'])}}"><i class="fa fa-plus me-1" aria-hidden="true"></i> Add Proposal</button>
            </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        var cat_table = $('#example').DataTable({
            ...
            ajax: "{{ action([App\Http\Controllers\Webproposal::class,'index']) }}",
            columns: [{
                    data: 'sno',
                    name: 'sno'
                },
        ...
        $(document).on('click', '.conformdelete', function() {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        $.ajax({
                            url: '/webproposal/' + Id, // Change this to your endpoint
                            type: 'DELETE',
                            data: {
                                id: Id,
                                _token: '{{ csrf_token() }}',
                        ...
                        window.location.href = '/webproposal';
                    }
                });
            });
