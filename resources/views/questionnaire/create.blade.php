<div class="modal-dialog cascading-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="title">Add Questionnaire</h4>
        </div>
        <!--Body-->
        <div class="modal-body mb-0">
            {!! Form::open(['route' => ['questionnaire.store'], 'method' => 'Post']) !!}
            ...
            <div class="row m-0 mb-0">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="alidate-input m-b-23 mb-2">
                    {!! Form::label('filename', 'File Name*', ['class' => 'label-color py-2'] ) !!}
                    {!! Form::text('filename', null, ['class' => 'form-control','required' => true, 'placeholder'=>'File Name']) !!}
                    </div>
                </div>
