<div class="modal-dialog cascading-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="title">Add SSL</h4>
        </div>
        <!--Body-->
        <div class="modal-body mb-0">
            {!! Form::open(['route' => ['ssl.store'], 'method' => 'Post']) !!}
            ...
            <div class="row m-0 mb-0">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="alidate-input m-b-23 mb-2">
                        {!! Form::label('source', 'SSL Server*', ['class' => 'label-color py-2']) !!}
                        <select class="form-select" name="source" required>
                                <option>Select From List</option>
                                <option name="source" value="Godaddy">Godaddy</option>
                                <option name="source" value="Reseller">Reseller</option>
                                <option name="source" value="AWS">AWS</option>
                            </select>
                    </div>
                </div>
