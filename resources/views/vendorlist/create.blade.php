<div class="modal-dialog cascading-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="title">Add Vendor List</h4>
        </div>

        <div class="modal-body mb-0">
            {!! Form::open(['route' => ['vendorlist.store'], 'method' => 'POST']) !!}
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check form-check-inline">
                                            {!! Form::radio('status', 'Active', true, ['id' => 'activeRadio1', 'class' => 'form-check-input', 'required']) !!}
                                            {!! Form::label('activeRadio1', 'Active', ['class' => 'label-color']) !!}
                                        </div>

                                        <div class="form-check form-check-inline">
                                            {!! Form::radio('status', 'Inactive', false, ['id' => 'inactiveRadio2', 'class' => 'form-check-input', 'required']) !!}
