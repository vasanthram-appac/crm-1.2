...
<div class="modal-dialog cascading-modal" role="document">
    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="title">Add Purchase Order</h4>
        </div>
        <!--Body-->

        <div class="modal-body mb-0">
            {!! Form::open(['route' => ['purchaseorder.store'], 'method' => 'Post']) !!}
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        <select class="form-select" name="statename_disable" id="">
                            ...
                            <option value="{{$state->name}}" @if($state->name == $vendorlist->state) selected @endif>{{$state->name}}</option>
                            @endforeach
                            @endif
                        </select>
            ...
            <div class="" style="border-bottom: 1px solid #ccc;">
                <h5 class="title">Purchase Order Description</h5>
            </div>
            ...
            <div class="row m-0 mb-0">
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::text('order_date', now()->format('d-m-Y'), ['class' => 'form-control', 'readonly']) !!}
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::text('order_no', $in_number, ['class' => 'form-control', 'readonly']) !!}
