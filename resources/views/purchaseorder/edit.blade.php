<div class="modal-dialog cascading-modal" role="document">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body mb-0">
            ...
            {!! Form::model($purchaseorderdetails, ['route' => ['purchaseorder.update', $purchaseorderdetails->id], 'method' => 'PUT']) !!}
            ...
            <div class="row m-0 mb-0">
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::hidden('company_id', $vendorlist->id , ['class' => 'form-control', 'readonly']) !!}
                        {!! Form::text('company_name', $vendorlist->company_name , ['class' => 'form-control', 'readonly']) !!}
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::textarea('address', $vendorlist->address , ['class' => 'form-control', 'readonly', 'rows'=>4]) !!}
            ...
            <div class="row m-0 mb-0">
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::text('phone', $vendorlist->phone, ['class' => 'form-control', 'readonly']) !!}
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::text('pincode', $vendorlist->pincode, ['class' => 'form-control', 'readonly']) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="row m-0 mb-0">
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::text('contact_person', $vendorlist->firstname . ' ' . $vendorlist->lastname, ['class' => 'form-control', 'readonly']) !!}

                    </div>
                </div>

                @if($vendorlist->city!='Dubai')
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        {!! Form::label('gst_number', 'GST Number', ['class' => 'label-color py-2']) !!}
                        {!! Form::text('gst_number', $vendorlist->gst_number, ['class' => 'form-control', 'readonly']) !!}
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        <select class="form-select" name="statename_disable" id="">
                            ...
                            <option value="{{$state->name}}"  @if(isset($purchaseorderdetails->statename) && $state->name == $purchaseorderdetails->statename) selected 
                                @elseif(isset($vendorlist->state) && $state->name == $vendorlist->state) selected @endif>{{$state->name}}</option>
                            @endforeach
                            @endif
                        </select>
                         <input type="hidden" name="statename" value="{{$purchaseorderdetails->statename}}">
                    </div>
                </div>
            ...
            <div class="row m-0 mb-0">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::textarea('shipping_address', $vendorlist->shipping_address ?? $vendorlist->address , ['class' => 'form-control', 'readonly', 'rows'=>4]) !!}
            ...
            <div class="row m-0 mb-0">
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::text('shipping_phone', $vendorlist->shipping_phone ?? $vendorlist->phone , ['class' => 'form-control', 'readonly']) !!}
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::text('shipping_pincode', $vendorlist->shipping_pincode ?? $vendorlist->pincode , ['class' => 'form-control', 'readonly']) !!}
            ...
            <div class="" style="border-bottom: 1px solid #ccc;">
                <h5 class="title">Purchase Order Details</h5>
            </div>

            <div class="row m-0 mb-0">
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        {!! Form::label('order_date', 'Key Notes', ['class' => 'label-color py-2']) !!}
                        {!! Form::text('order_date', $purchaseorderdetails->order_date, ['class' => 'form-control', 'readonly']) !!}
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        {!! Form::label('order_no', 'Reference No', ['class' => 'label-color py-2']) !!}
                        {!! Form::text('order_no', $purchaseorderdetails->order_no, ['class' => 'form-control', 'readonly']) !!}
            ...
            <div class="table-responsive">
                <table class="table table-hover invoice-input">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><input id="item_no_{{$key+1}}" type="text" name="item_no_{{$key+1}}" value="{{$purchaseorder1->item_no}}" class="input-mini"></td>
                            <td><input id="description_{{$key+1}}" type="text" name="description_{{$key+1}}" value="{{$purchaseorder1->description}}" class="input-xlarge"></td>
                            <td><input id="hsn_{{$key+1}}" type="text" name="hsn_{{$key+1}}" value="{{$purchaseorder1->hsn}}" class="input-xlarge"></td>
                            <td><input onkeyup="sum();" id="quantity_{{$key+1}}" type="text" name="quantity_{{$key+1}}" value="{{$purchaseorder1->quantity}}" class="input-mini"></td>
                            <td><input onkeyup="sum();" id="unit_{{$key+1}}" type="text" name="unit_{{$key+1}}" value="{{$purchaseorder1->unit}}" class="input-mini"></td>
                            <td><input onkeyup="sum();" id="totalamount_{{$key+1}}" type="text" name="totalamount_{{$key+1}}" value="{{$purchaseorder1->totalamount}}" class="input-mini" readonly></td>
                            <input type="hidden" name="updateid_{{$key+1}}" value="{{$purchaseorder1->id}}">
                            <td><button class="btn btn-modal conformdelete" data-id="{{$purchaseorder1->id}}" data-inid="{{$purchaseorder1->order_no}}"><i class="fi fi-ts-trash-xmark"></i></button></td>

                        </tr>
                        @endforeach
                        @endif

                        @for($i = count($purchaseorder) + 1; $i <= 5; $i++)
                            <tr>
                ...
                <thead>
                    ...
                    <tr>
                        <th class="d-flex flex-wrap gap-2">
                            Total Amount
                            <input type="text" id="amount_pay" name="amount" class="input-xlarge" value="{{$purchaseorder->sum('totalamount')}}" readonly>
            ...
            <div class="table table-hover invoice-input" id="ingst" style="display:none;">
                ...
                <div class="text-center" id="submitproformaid1" style="display:none;">
                    ...
                    <div class="btn-g2">
                        <div></div>
                        <div></div>
                        <button type="submit" data-id="8" class="frm-btn pri-text-color" role="button"> Generate Purchase Order </button>
