...
<div class="d-flex justify-content-between  align-items-end  inside-nav mb-4">
        ...
        <ul class="nav nav-tabs  my-4  justify-content-end  mb-0  ">
            ...
            <li class="nav-item">
                <a class="nav-link active"  href="/backup"><b>Backup</b></a>
            </li>
    ...
    <div class="profile  col-12 col-lg-12 col-xl-12 col-xxl-12 d-flex justify-content-between flex-wrap  align-items-center  p-15">
        <div class="profile-head">
            <h1 class="ch2 comp-name">Backup</h1>
        </div>
        <!-- <div class="justify-content-sm-end d-flex">
            <div class=""></div>
            <button class="btn bg-primary text-white ft-15 btn-modal pri-text-color m-0 " data-container=".customer_modal" data-href="{{action([App\Http\Controllers\Backup::class,'create'])}}"><i class="fa fa-plus me-1" aria-hidden="true"></i> Add Backup</button>
        </div> -->
    </div>
                ...
                <table id="example" class="dataTable mt-6 table table-bordered ">
                    <thead>
                        <tr class="bg-white">
                            ...
                            <th class="text-grey">Database Name</th>
                            <th class="text-grey">Month</th>
                            <th class="text-grey">Created</th>
                            <th class="text-grey">Download Path</th>
...
<script>
    $(document).ready(function() {
        ...
        var cat_table = $('#example').DataTable({
            ...
            ajax: "{{ action([App\Http\Controllers\Backup::class,'index']) }}",
            columns: [{
                    data: 'sno',
                    name: 'sno'
                },
