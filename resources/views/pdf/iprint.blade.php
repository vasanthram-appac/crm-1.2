...
<body>
    ...
    <div id="divToPrint" style="position: relative; ">
        ...
        <div class="cover_img" style="position: absolute; width: 930px;">
            ...
            <div class="flex" style="font-family: 'Inter', sans-serif; font-size: 14px; position: absolute; width: fit-content; left: 525px; top: 25px; display: flex; gap: 20px;">
                <div>Invoice No : <b>{{ $invoice->invoice_no ?? 'N/A' }}
                    </b></div>
                <div style="font-family: 'Inter', sans-serif;">Date : <b>{{ $invoice->invoice_date ? date('d-m-Y', strtotime($invoice->invoice_date)) : 'N/A' }}
                    </b></div>
            </div>
            <div style="border: 1px solid black; font-family: 'Inter', serif; width:870px; position: relative; top: 50px; margin: auto">
                <table border="0" frame="box" style="border-collapse: collapse; width: 870px; margin-top: 0px;border-left:0px;border-right:0px;border-top:0px;">
                    ...
                    <table style="border-collapse: separate; border-spacing: 0 0px; width: 100%; font-size: 13px;">
                        ...
                        <tr>
                            <th style="text-align: left; font-family: 'Work Sans', sans-serif; padding-left: 10px; padding-top: 10px; border-top: 1px solid black; border-right: 1px solid black;font-size:13px">Key Notes: <br> <br>
                            ...
                            <div style="display:flex;align-items:center;justify-content:right;position: absolute;left: 35%;right: 30%;top: 60%;background-color:#fff;    z-index: -2;">
                                <img src="https://appacmedia.in/imgs/appac-watermark.svg" class="" style="width:320px;background-color:#fff;" />
                            </div>
            ...
            <div style="font-family: 'Inter', serif; border: 1px solid black; width:870px; position: relative; top: 40px; margin: auto; margin-top: 15px;" id="divToPrint">
                ...
                <table style="border-collapse: separate; border-spacing: 0 0px; width: 100%;">
                    ...
                    <tbody>
                                    ...
                                    <table style="border-collapse: separate; border-spacing: 0 0px; width: 120%;">
                                        ...
                                        <tbody style="color:#464141">
                                            <tr style="padding-left: 10px;">
                                                <td align="left">
                                            <tr>
                                                <td style="font-family: 'Inter', sans-serif;font-size: 12px; ">
                                                    <li>Please be aware that you must communicate any changes to this tax invoice via email within 7 days.</li>
                                                </td>
                                            </tr>
                            </td>
                            <td align="left">
                        <tr>
                            <td style="font-family: 'Inter', sans-serif;font-size: 12px;">
                                <li style="list-style: none; padding-left: 17px;">After 7 days, the invoice will be considered accepted by the customer and not changed.</li>
                            </td>
                        </tr>
                        </td>
                        <td align="left">
                            <tr>
                                <td style="font-family: 'Inter', sans-serif;font-size: 12px;">
                                    <li>Company liability is only up to the value of the invoice.</li>
                                </td>
                            </tr>
                        </td>
                        <td align="left">
                            <tr>
                                <td style="font-family: 'Inter', sans-serif;font-size: 12px;">
                                    <li>Acceptance of the invoice signifies acceptance of the agreed service levels.</li>
                                </td>
                            </tr>
                        </td>
                        <td align="left">
                            <tr>
                                <td class="" style="font-family: 'Inter', sans-serif; font-size: 12px;">
                                    <li>The recipient of this invoice has fully and duly verified all contents, data, input files, and copies.</li>
                                </td>
                            </tr>
                        </td>
                        <td align="left">
                            <tr>
                                <td style="font-family: 'Inter', sans-serif;padding-bottom: 10px; font-size: 12px;">
                                    <li>Payment to us is covered under advertising contract u/s 194C. TDS, if applicable, will be @ 2%.</li>
                                </td>
                            </tr>
                        </td>
                        </tr>
                        <tr>
                            <td align="left">
                        <tr>
                            <td style="font-family: 'Inter', sans-serif;font-size: 12px;border-top: 1px solid #000;    padding-top: 12px;"><b style="font-family: 'Inter', sans-serif;font-weight: 500; color: #000;">Note</b> : Cheque / Draft to be made in the favour of <b style="font-family: 'Inter', sans-serif;font-weight: 500; color: #000;">APPAC MEDIATECH PVT. LTD.</b></td>
                        </tr>
                        </td>
                        <td align="left">
                            <tr>
                                <td style="font-family: 'Inter', sans-serif;font-size: 12px;"><b style="font-family: 'Inter', sans-serif;font-weight: 500; color: #000;">PAN</b> : AAQCA4617E &nbsp;&nbsp;|&nbsp;&nbsp; <b style="font-family: 'Inter', sans-serif;font-weight: 500; color: #000;">GST No</b> : 33AAQCA4617E1ZU &nbsp;&nbsp;|&nbsp;&nbsp; <b style="font-family: 'Inter', sans-serif;font-weight: 500; color: #000;"> TAN </b>: CMBA09095C</td>
                            </tr>
                        </td>
                        <td align="left">
                            <tr>
                                <td style="font-family: 'Inter', sans-serif;font-size: 12px;"><b style="font-weight: 500; color: #000;">SAC CODE</b>: 9983 &nbsp;&nbsp;|&nbsp;&nbsp; <b style="font-family: 'Inter', sans-serif;font-weight: 500; color: #000;"> LUT No</b> : AD330419005161L</td>
                            </tr>
                        </td>
                        </tr>
                    </tbody>
