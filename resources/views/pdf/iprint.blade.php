       ...
       <!-- <img src="imgs/invoice_cover.jpg" class="cover_img" style=" width: 930px; background-size: cover; background-repeat: no-repeat;position:absolute;"/>-->
		<div class="wid"style="width:930px;">
			<div class="head_grid" style="width: 870px; margin:auto; display: grid; grid-template-columns: 25% 35% 40%; align-items: end;background-color:#fff;">
				<img src="/img/head-logo.png" alt="" style="width: 198px; padding-left: 10px;background-color:#fff;">
				<div class="head_add" style="width: 100%; padding-bottom: 9px;">
					<b style="font-family: 'Work Sans', sans-serif; font-size: 15px; font-weight: 800; line-height: 25px; color:#221b53;">APPAC MEDIATECH PVT. LTD.</b><br>
                        ...
                        <table border="0" frame="box" style="border-collapse: collapse; width: 870px; margin-top: 0px;border-left:0px;border-right:0px;border-top:0px;">              
                            ...
                            <table style="border-collapse: separate; border-spacing: 0 10px; width: 100%; font-size: 13px;">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left; font-family: 'Work Sans', sans-serif; font-size: 15px; padding-bottom: 10px; padding-left: 0px; border-bottom: 1px solid black;">HSN / SAC</th>
                                    <th style="text-align: left; font-family: 'Work Sans', sans-serif; font-size: 15px; padding-bottom: 10px; border-bottom: 1px solid black;">Quantity<br><span style="font-size: 12px; color:#464141; font-weight: 400;">(Nos)</span></th>
                                    <th style="text-align: left; font-family: 'Work Sans', sans-serif; font-size: 15px; padding-bottom: 10px; border-bottom: 1px solid black;">Unit price<br><span style="font-size: 12px; color:#464141; font-weight: 400;">(INR)</span></th>
                                    <th style="text-align: left; font-family: 'Work Sans', sans-serif; font-size: 15px; border-bottom: 1px solid black; padding: 0px 60px 10px 50px;">Total<br><span style="font-size: 12px; color:#464141; font-weight: 400;">(INR)</span></th>
                                </tr>
                                ...
                                <tbody style="color:#464141">
                                    ...
                                    <tr style="padding-left: 10px;">
                                        ...
                                        <td style="font-family: 'Inter', sans-serif; padding-left: 15px;">{{ !empty($info->hsn) ? $info->hsn : 9983}}</td>
                                        <td style="font-family: 'Inter', sans-serif;padding-left: 15px;">&nbsp;{{$info->quantity}}</td>
                                        <td style="font-family: 'Inter', sans-serif;padding-right: 10px; text-align: right;">{{number_format($info->unit ?? 0,2)}}&nbsp;</td>
                                        <td style="font-family: 'Inter', sans-serif;padding-right: 34px; text-align: right;">{{number_format($info->totalamount ?? 0,2)}}</td>
                                    </tr>
                                    @endforeach
                                    @endif 
								...
								<tr>   
								 <td align="right" style="border-right: 1px solid black;"></td>
								  @if($invoice->gsttype =='in')
                                    <td style="text-align: right;  padding: 10px 0px 0px 0px;font-size:13px"><b>Taxable Value Rs. </b></td>
                                    @else
                                    <td style="text-align: right; padding: 10px 0px 0px 0px;font-size:13px"><b>Taxable Value Rs. </b></td>
                                    @endif
								
								@if($invoice->gsttype =='in')
                                    <td style="text-align: right;  padding-right: 35px; padding-top: 10px;font-size:13px"><b>{{number_format($invoice->principle ?? 0,2)}}</b></td>
                                     @else
                            ...
                            ?>
                                ...
                                <span style="font-family: 'Inter', sans-serif; color:#464141">{{ $result . ' Rupees Only' }}</span></td>
                                        <td align="right" style="font-family: 'Inter', sans-serif;padding: 10px 0px 15px 0px;border-left:1px solid #00000;font-size:15px"><b>NET PAY Rs.</b></td>
                                        <td align="right" style="font-family: 'Inter', sans-serif;padding-right: 35px; padding-top: 10px; padding-bottom: 15px;font-size:15px"><b>{{number_format($invoice->grosspay ?? 0,2)}}</b></td>                       
                                    </tr>                    
                                </tbody>                
                            </table>
                        </table>
                                            ...
                                            <table style="border-collapse: separate; border-spacing: 0 0px; width: 120%;">
                                                ...
                                                <tbody style="color:#464141">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" ><tr><td style="font-family: 'Inter', sans-serif;font-size: 12px;"> <b style="font-family: 'Inter', sans-serif;font-weight: 500; color: #000;"> LUT No</b> : AD330419005161L</td></tr></td>
                                                    </tr>					
                                                </tbody>                
                                            </table>
                                        </div>
