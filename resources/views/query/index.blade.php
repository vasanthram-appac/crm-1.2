    ...
    <div class="col-lg-12 col-sm-12 p-0">
        <div class="panel row" id="firstRow">
            ...
            <div class="my-3 justify-content-sm-end d-flex">
                <div class=""></div>
                <button class="btn bg-primary text-white ft-15 btn-modal pri-text-color m-0 " data-container=".customer_modal" data-href="{{ route('queryadd', ['id' => $id]) }}"><i class="fa fa-plus me-1" aria-hidden="true"></i> Add Query</button>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        var cat_table = $('#example').DataTable({
            ...
            ajax: "{{ route('queryindex', ':id') }}".replace(':id', id),
            columns: [{
                    data: 'sno',
                    name: 'sno'
                },
