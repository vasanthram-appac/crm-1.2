...
<div class="row m-0 appac_hide">
    <div class="d-flex justify-content-between  align-items-end  inside-nav mb-4">
        ...
        @if(request()->session()->get('role') != 'user')
            ...
            <li class="nav-item">
                <a class="nav-link active"  href="/promotion"><b>Promotion</b></a>
            </li>
            <li class="nav-item">
...
<div class="profile  col-12 col-lg-12 col-xl-12 col-xxl-12 d-flex justify-content-between flex-wrap  align-items-center  p-15">
        <div class="profile-head">
            <h1 class="ch2 comp-name">Promotion</h1>
        </div>
        <div class="justify-content-sm-end d-flex">
                <div class=""></div>
                <button class="btn bg-primary text-white ft-15 btn-modal pri-text-color m-0 " data-container=".customer_modal" data-href="{{action([App\Http\Controllers\Promotion::class,'create'])}}"><i class="fa fa-plus me-1" aria-hidden="true"></i> Add Promotion</button>
            </div>
    </div>
                ...
                <table id="example" class="dataTable mt-6 table table-bordered ">
                    <thead>
                        <tr class="bg-white">
                            ...
                            <th class="text-grey">Promotion Type</th>
                            <th class="text-grey">Contract Period</th>
                            <th class="text-grey">Promotion Person</th>
...
<script>
    $(document).ready(function() {
        ...
        var cat_table = $('#example').DataTable({
            ...
            ajax: "{{ action([App\Http\Controllers\Promotion::class,'index']) }}",
            columns: [{
                    data: 'sno',
                    name: 'sno'
                },
