<div class="modal-dialog cascading-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="title">Convert Leads</h4>
        </div>

        <div class="modal-body mb-0">
            {!! Form::model($newnbd, ['route' => ['savelead', $newnbd->id], 'method' => 'POST']) !!}
            <div class="row m-0 mb-0">
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                         {!! Form::hidden('id', $newnbd->id) !!}
                        {!! Form::label('company_name', 'Company Name*', ['class' => 'label-color py-2']) !!}
                        {!! Form::text('company_name', $newnbd->company_name, ['class' => 'form-control', 'placeholder' => 'Enter Company Name']) !!}
                    </div>
                </div>
            ...
            <div class="row m-0 mb-0">
                <div class="col-lg-6 col-sm-12">
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::text('firstname', $newnbd->name, ['class' => 'form-control', 'placeholder' => 'First Name']) !!}
                    </div>
                </div>
            ...
            <div class="row m-0 mb-0">
                    ...
                    <div class="validate-input m-b-23 mb-2">
                        ...
                        {!! Form::number('phone', $newnbd->mobile, ['class' => 'form-control', 'placeholder' => 'Enter Phone Number', 'maxlength' => '10', 'onkeypress' => 'return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))']) !!}
                    </div>
                    </div>
                    ...
                    <div class="row m-0 mb-0">
                        <div class="col-lg-6 col-sm-12">
                            <div class="validate-input m-b-23 mb-2">
                                ...
                                {!! Form::email('emailid', $newnbd->email, ['class' => 'form-control', 'placeholder' => 'Primary Email']) !!}
                    ...
                    <div class="row m-0 mb-0">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="validate-input m-b-23 mb-2">
                                ...
                                {!! Form::textarea('summary', $newnbd->description, ['class' => 'form-control', 'rows' => '5', 'placeholder' => 'Brief Description', 'style' => 'resize:none;']) !!}
                                <span class="focus-input100"></span>
                            </div>
                        </div>
