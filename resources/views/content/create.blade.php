    ...
    <div class="modal-content">
        ...
        <div class="modal-body mb-0">
            ...
            <div class="row m-0 mb-0">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="alidate-input m-b-23 mb-2">
                        ...
                        {!! Form::select('promotion_person', $promotion, null, ['class' => 'form-select', 'required' => true]) !!} </div>
                </div>
            ...
            <div class="row m-0 mb-0">
                <div class="col-lg-6 col-sm-12">
                    <div class="alidate-input m-b-23 mb-2">
                        {!! Form::label('task_status', 'Task Status *', ['class' => 'label-color py-2']) !!}
            ...
            <div class="row m-0 mb-0">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="alidate-input m-b-23 mb-2">
                        ...
                        {!! Form::select('mail_cc[]', $mail, null, ['class' => 'form-control select2', 'multiple' => true]) !!}
                    </div>
                </div>
