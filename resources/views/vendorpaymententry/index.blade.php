...
<div class="row m-0 appac_hide">
        ...
        <div class="col-lg-4 col-sm-12">
            <div class="alidate-input m-b-23 mb-2">
                <p class="fs-4 pt-5 totalamount mb-0">
                    @if(request()->session()->has('totalvendorpaymententry'))
                    INR. {{request()->session()->get('totalvendorpaymententry')}}
                    @else
                    INR. 0.00
                    @endif
                </p>
    ...
    <div class="profile col-12 col-lg-12 col-xl-12 col-xxl-12 d-flex justify-content-between flex-wrap  align-items-center  p-15">
        ...
        <div class="justify-content-sm-end d-flex">
            <div class=""></div>
            <button class="btn bg-primary text-white ft-15 btn-modal pri-text-color m-0 " data-container=".customer_modal" data-href="{{action([App\Http\Controllers\Vendorpaymententry::class,'create'])}}"><i class="fa fa-plus me-1" aria-hidden="true"></i> Add Payment</button>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        var cat_table = $('#example').DataTable({
            ...
            ajax: "{{ action([App\Http\Controllers\Vendorpaymententry::class,'index']) }}",
            columns: [{
                    data: 'sno',
                    name: 'sno'
                },
    ...
    $('#searchpaysubmit').on('click', function() {
        ...
        $.ajax({
            url: "{{ action([App\Http\Controllers\Vendorpaymententry::class, 'index']) }}",
            type: 'GET',
            data: {
